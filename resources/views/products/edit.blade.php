...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" id="addProductForm">
                @csrf
                @method('PUT')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="number" name="dimensions" class="form-control" value="{{ $product->dimensions }}">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" name="quantity_available" class="form-control" value="{{ $product->quantity_available }}" required>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-check form-check-inline toggle-switch">
                    <input type="radio" name="active" id="active_yes" value="1" class="form-check-input"  {{ $product->active == 1 ? 'checked' : '' }} required>
                    <label class="form-check-label" for="active_yes" >Yes</label>
                </div>
                <div class="form-check form-check-inline toggle-switch">
                    <input type="radio" name="active" id="active_no" value="0" class="form-check-input"  {{ $product->active == 0 ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline toggle-switch">
                    <input type="radio" name="featured" id="featured_yes" value="1" class="form-check-input"  {{ $product->featured == 1 ? 'checked' : '' }} required>
                    <label class="form-check-label" for="featured_yes" >Yes</label>
                </div>
                <div class="form-check form-check-inline toggle-switch">
                    <input type="radio" name="featured" id="featured_no" value="0" class="form-check-input"  {{ $product->featured == 0 ? 'checked' : '' }} required>
